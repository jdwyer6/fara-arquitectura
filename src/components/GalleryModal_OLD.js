...
const GalleryModal = () => {
    return ( 
        // className='bg-white w-5/6 min-h-screen absolute top-1/2 left-1/2 flex flex-col' style={{transform: 'translate(-50%, -50%)'}}
        <div className="bg-white  top-0 w-screen h-full z-20">
            <div className=''>
                <div className='flex items-center bg-white rounded-xl shadow-lg px-8 py-4'>
                    <TfiClose />
                    <p className='pl-4'>Close Gallery</p>
                </div>

            </div>
            <div className='p-16 image-gallery'>
                <img src={page1}/>
                <img src={page12}/>
                <img src={page13}/>
                <img src={page14}/>
